...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        // Создаём объекты репозиториев Магазина
        ProductRepository productRepository= new ProductRepositoryImpl();
        CustomerRepository customerRepository = new CustomerRepositoryImpl();

        // Создаём объекты сервисов Магазина
        ProductService productService = new ProductServiceImpl(productRepository);
        CustomerService customerService = new CustomerServiceImpl(customerRepository, productService);

        // Создаём объекты контроллеров Магазина (к ним мы и будем обращаться в коде Клиента)
